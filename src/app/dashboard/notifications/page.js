...
import {
    ...
    MessageSquare, AlertCircle, Clock, RefreshCw,
} from 'lucide-react';
...
const TYPE_CONFIG = {
    ...
    agreement_renewed: { label: 'Agreement Renewed', icon: FileText, color: 'bg-purple-100 text-purple-600' },
...
export default function NotificationsPage() {
    ...
    const fetchNotifications = useCallback(async (p = 1, f = filter) => {
        setLoading(true);
        try {
