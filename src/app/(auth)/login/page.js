    ...
    <div className="flex min-h-screen flex-col bg-transparent">
      <div className="flex flex-1 items-center justify-center px-4 py-16 sm:px-8">
        <div className="mx-auto grid w-full max-w-6xl items-center gap-10 md:grid-cols-[minmax(0,1.1fr),minmax(0,1.1fr)]">
            ...
            <div className="mt-8 grid max-w-md grid-cols-2 gap-3 text-left text-[0.8rem]">
              <div className="rf-card-soft p-4">
                ...
                <p className="mt-2 text-sm font-semibold text-neutral-900">
                  Track every application and lease from a single, calm dashboard.
                </p>
              </div>
              <div className="rf-card-soft p-4">
                <p className="text-[0.7rem] font-semibold uppercase tracking-[0.18em] text-neutral-500">
                ...
                <p className="mt-2 text-sm font-semibold text-neutral-900">
                  See payments, renewals, and maintenance in real time.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="rf-glass-dark rf-fade-in-up w-full max-w-md justify-self-end px-8 py-9">
            ...
            {!needs2FA && !needsEmailVerify && !needsPhoneVerify && (
              <>
                ...
                <a
                  ...
                  className="rf-btn rf-btn-secondary mb-4 flex w-full justify-center rounded-2xl border border-slate-600/70 bg-slate-900/70 py-3 text-sm text-slate-50 hover:bg-slate-800/90"
                >
                  <svg
                    viewBox="0 0 24 24"
                    className="h-5 w-5"
